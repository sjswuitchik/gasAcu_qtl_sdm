...
COMBOTE<-raster("Processed_files/COMBOTE_Jul16_rcp4_tolerrat_adjPVE.asc")
COMBOTEWARM<-raster("Processed_files/COMBO_TOL_E_W_Jul16_rcp4_tolerrat_adjPVE.asc")
...
#Plot-Warmer World
pdf("Figs/rcp4_evol_adjPVE_warmer.pdf")
