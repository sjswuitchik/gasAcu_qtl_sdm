...
COMBOTE<-raster("Processed_files/COMBOTE_Jan13_rcp8_noevol.asc")
COMBOTEWARM<-raster("Processed_files/COMBO_TOL_E_W_Jan13_rcp8_noevol.asc")
...
#pdf("Figs/rcp8_noevol_current.pdf")
