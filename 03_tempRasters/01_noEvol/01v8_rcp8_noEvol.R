...
writeRaster(COMBOTE,"outputs/Processed_files/COMBOTE_jan2022_rcp8_noEvol.asc",format="ascii")
writeRaster(COMBOTEW,"outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp8_noEvol.asc",format="ascii")
