...
writeRaster(TOL,"Processed_files/TOL_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(ERRAT,"Processed_files/ERRAT_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(PREF,"Processed_files/PREF_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(COMBOTE,"Processed_files/COMBOTE_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(TOLW,"Processed_files/TOLW_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(ERRATW,"Processed_files/ERRATW_June20_rcp8_lowerEvol.asc",format="ascii")
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_June20_rcp8_lowerEvol.asc",format="ascii")
