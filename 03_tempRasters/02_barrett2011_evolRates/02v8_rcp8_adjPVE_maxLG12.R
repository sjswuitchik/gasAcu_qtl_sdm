## CTmax, adjusted PVE, LG XII PVE 45.2%
...
evol.tol.lb <- tol.lb 
evol.tol.ub <- tol.ub + 1.44
evol.errat.lb <- errat.lb 
evol.errat.ub <- errat.ub + 1.44
...
writeRaster(TOL,"Processed_files/TOL_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(ERRAT,"Processed_files/ERRAT_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(PREF,"Processed_files/PREF_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(COMBOTE,"Processed_files/COMBOTE_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(TOLW,"Processed_files/TOLW_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(ERRATW,"Processed_files/ERRATW_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_Jul14_rcp8_adjPVE_maxLG12.asc",format="ascii",overwrite=TRUE)
