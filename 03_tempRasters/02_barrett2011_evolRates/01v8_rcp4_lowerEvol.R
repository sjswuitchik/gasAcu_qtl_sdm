...
writeRaster(COMBOTE,"outputs/Processed_files/COMBOTE_jan2022_rcp4_lowerEvol.asc",format="ascii")
writeRaster(COMBOTEW,"outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp4_lowerEvol.asc",format="ascii")
