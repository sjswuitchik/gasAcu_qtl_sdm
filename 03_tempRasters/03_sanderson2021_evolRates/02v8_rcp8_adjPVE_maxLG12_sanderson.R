...
evol.tol.lb <- tol.lb 
evol.tol.ub <- tol.ub + 5.6
evol.errat.lb <- errat.lb 
evol.errat.ub <- errat.ub + 5.6
...
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_dec2021_rcp8_adjPVE_maxLG12_sanderson_hardBound.asc",format="ascii",overwrite=TRUE)
