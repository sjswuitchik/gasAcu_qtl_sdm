...
evol.tol.lb <- tol.lb 
evol.tol.ub <- tol.ub + 9.7
evol.errat.lb <- errat.lb 
evol.errat.ub <- errat.ub + 9.7
...
writeRaster(COMBOTEW,"outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp8_adjPVE_maxLG12_sanderson.asc",format="ascii", overwrite=TRUE)
