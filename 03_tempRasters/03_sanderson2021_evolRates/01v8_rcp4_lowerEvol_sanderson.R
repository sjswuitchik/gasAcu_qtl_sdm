...
evol.tol.lb <- tol.lb - 0.36
evol.tol.ub <- tol.ub 
evol.errat.lb <- errat.lb - 0.36
...
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_dec2021_rcp4_lowerEvol_sanderson.asc",format="ascii")
