...
evol.tol.lb <- tol.lb - 0.19
evol.tol.ub <- tol.ub 
evol.errat.lb <- errat.lb - 0.19
...
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_dec2021_rcp8_adjPVE_minLG21_sanderson.asc",format="ascii",overwrite=TRUE)
