...
evol.tol.lb <- tol.lb 
evol.tol.ub <- tol.ub + 0.30
evol.errat.lb <- errat.lb 
evol.errat.ub <- errat.ub + 0.30
...
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_dec2021_rcp4_adjPVE_maxLG21_sanderson.asc",format="ascii")
