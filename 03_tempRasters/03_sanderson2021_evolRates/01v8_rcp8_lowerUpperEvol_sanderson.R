...
evol.tol.ub <- tol.ub + 12.3
evol.errat.lb <- errat.lb - 5
evol.errat.ub <- errat.ub + 12.3
...
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_dec2021_rcp8_lowerUpperEvol_sanderson_hardBound.asc",format="ascii")
