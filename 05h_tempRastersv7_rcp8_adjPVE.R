...
writeRaster(TOL,"Processed_files/TOL_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(ERRAT,"Processed_files/ERRAT_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(PREF,"Processed_files/PREF_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(COMBOTE,"Processed_files/COMBOTE_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(TOLW,"Processed_files/TOLW_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(ERRATW,"Processed_files/ERRATW_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_Nov30_rcp8_adjPVE_minOnly.asc",format="ascii")
