...
COMBOTE<-raster("Processed_files/COMBOTE_Jul16_rcp8_tolerrat_adjPVE.asc")
COMBOTEWARM<-raster("Processed_files/COMBO_TOL_E_W_Jul16_rcp8_tolerrat_adjPVE.asc")
...
#Plot-Warmer World
pdf("Figs/rcp8_evol_adjPVE_warmer.pdf")
