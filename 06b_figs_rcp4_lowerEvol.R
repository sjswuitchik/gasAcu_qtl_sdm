...
COMBOTE<-raster("Processed_files/COMBOTE_Nov3_rcp4_lowerEvol.asc")
COMBOTEWARM<-raster("Processed_files/COMBO_TOL_E_W_Nov3_rcp4_lowerEvol.asc")
...
#Plot-Warmer World
pdf("Figs/rcp4_lowerEvol_warmer.pdf")
