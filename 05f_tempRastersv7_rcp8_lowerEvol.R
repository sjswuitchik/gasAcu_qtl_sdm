...
writeRaster(TOL,"Processed_files/TOL_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(ERRAT,"Processed_files/ERRAT_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(PREF,"Processed_files/PREF_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(COMBOTE,"Processed_files/COMBOTE_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(TOLW,"Processed_files/TOLW_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(ERRATW,"Processed_files/ERRATW_Nov26_rcp8_lowerEvol.asc",format="ascii")
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_Nov26_rcp8_lowerEvol.asc",format="ascii")
