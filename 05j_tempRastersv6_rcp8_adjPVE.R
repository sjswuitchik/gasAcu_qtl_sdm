...
writeRaster(TOL,"Processed_files/TOL_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(ERRAT,"Processed_files/ERRAT_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(PREF,"Processed_files/PREF_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(COMBOTE,"Processed_files/COMBOTE_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(TOLW,"Processed_files/TOLW_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(ERRATW,"Processed_files/ERRATW_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
writeRaster(COMBOTEW,"Processed_files/COMBO_TOL_E_W_Feb9_rcp8_tolerrat_adj.asc",format="ascii")
