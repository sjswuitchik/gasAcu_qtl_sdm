...
r4min3<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp4_adjPVE_minLG03_sanderson.asc") 
...
r4max20<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp4_upperEvol.asc") #rasters are identical
proj4string(r4max20)<-CRS("+init=epsg:4326")
r4max12<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp4_adjPVE_maxLG12_sanderson.asc")
proj4string(r4max12)<-CRS("+init=epsg:4326")
r8min3<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp8_adjPVE_minLG03_sanderson.asc")
...
r8max20<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp8_upperEvol.asc") #rasters are identical
proj4string(r8max20)<-CRS("+init=epsg:4326")
r8max12<-raster("outputs/Processed_files/COMBO_TOL_E_W_jan2022_rcp8_adjPVE_maxLG12_sanderson.asc") 
...
r4EW[r4EW!=3]<-NA
pdf("outputs/Figs/r4EW_sanderson.pdf")
plot(r4EW)
dev.off()
...
r8EW[r8EW!=3]<-NA
pdf("outputs/Figs/r8EW_sanderson.pdf")
plot(r8EW)
dev.off()
...
r4min3[r4min3!=3]<-NA
pdf("outputs/Figs/r4min3_sanderson.pdf")
plot(r4min3)
dev.off()

r4min21[r4min21!=3]<-NA
pdf("outputs/Figs/r4min21_sanderson.pdf")
plot(r4min21)
dev.off()

r4max20[r4max20!=3]<-NA
pdf("outputs/Figs/r4max20_sanderson.pdf")
plot(r4max20)
dev.off()

r4max12[r4max12!=3]<-NA
pdf("outputs/Figs/r4max12_sanderson.pdf")
plot(r4max12)
dev.off()

r8min3[r8min3!=3]<-NA
pdf("outputs/Figs/r8min3_sanderson.pdf")
plot(r8min3)
dev.off()

r8min21[r8min21!=3]<-NA
pdf("outputs/Figs/r8min21_sanderson.pdf")
plot(r8min21)
dev.off()

r8max20[r8max20!=3]<-NA
pdf("outputs/Figs/r8max20_sanderson.pdf")
plot(r8max20)
dev.off()

r8max12[r8max12!=3]<-NA
pdf("outputs/Figs/r8max12_sanderson.pdf")
plot(r8max12)
dev.off()
...
pdf("outputs/Figs/r4minMaxEW_sanderson.pdf")
plot(r4minMaxEW)
dev.off()
...
pdf("outputs/Figs/r8minMaxEW_sanderson.pdf")
plot(r8minMaxEW)
dev.off()
...
pdf("outputs/Figs/r4maxW_sanderson.pdf")
plot(r4maxW)
dev.off()
pdf("outputs/Figs/r8maxW_sanderson.pdf")
plot(r8maxW)
dev.off()
