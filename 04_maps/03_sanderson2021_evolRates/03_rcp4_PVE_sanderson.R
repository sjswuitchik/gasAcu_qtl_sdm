...
r4min3<-raster("Processed_files/COMBO_TOL_E_W_dec2021_rcp4_adjPVE_minLG03_sanderson.asc")
r4min21<-raster("Processed_files/COMBO_TOL_E_W_dec2021_rcp4_adjPVE_minLG21_sanderson.asc")
r4max21<-raster("Processed_files/COMBO_TOL_E_W_dec2021_rcp4_adjPVE_maxLG21_sanderson.asc")
r4max12<-raster("Processed_files/COMBO_TOL_E_W_dec2021_rcp4_adjPVE_maxLG12_sanderson.asc")
...
#Plot-Warmer World
pdf("Figs/rcp4_minLG03_sanderson_warmer.pdf")
...
pdf("Figs/rcp4_minLG21_sanderson_warmer.pdf")
plot(D, col="grey",axes=F,legend=F)
plot(r4min21, add=T, legend=F, at=c(2,3),col=cols[2:3])
legend("bottomleft",legend=ltext,fill=cols,bg="white")
dev.off()

pdf("Figs/rcp4_maxLG21_sanderson_warmer.pdf")
plot(D, col="grey",axes=F,legend=F)
plot(r4max21, add=T, legend=F, at=c(2,3),col=cols[2:3])
legend("bottomleft",legend=ltext,fill=cols,bg="white")
dev.off()

pdf("Figs/rcp4_maxLG12_sanderson_warmer.pdf")
plot(D, col="grey",axes=F,legend=F)
